  ...
  _createClass(Promise, [{
    ...
    value: function reslove(value) {
      ...
      if (this.state === Promise.Pending) {
        setTimeout(function () {
          _this.state = Promise.Fulfiled;

          try {
            if (_this.onFulfileds.length > 0) {
              _this.onFulfileds[0].onfulfiled(value);
            }
          } catch (e) {
            _this.reject(e);
          }
    ...
    value: function reject(value) {
      ...
      if (this.state === Promise.Pending) {
        setTimeout(function () {
          _this2.state = Promise.Rejected;

          try {
            if (_this2.onRejects.length > 0) {
              _this2.onRejects[0].onreject(value);
            }
          } catch (e) {
            _this2.reject(e);
          }
    ...
    key: "then",
    value: function then(onfulfiled, onreject) {
      if (this.state === Promise.Pending) {
...
_defineProperty(Promise, "Pending", "pending");

_defineProperty(Promise, "Fulfiled", "fulfiled");

_defineProperty(Promise, "Rejected", "rejected");
